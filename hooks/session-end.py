...
def main() -> None:
    ...
    # Mark this session as swept so the Stop-hook orphan sweeper doesn't
    # re-flush the same transcript later (would otherwise produce duplicate
    # journal entries since flush.py's 60s dedup window is short-lived).
    try:
